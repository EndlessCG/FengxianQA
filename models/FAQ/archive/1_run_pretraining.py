...
def main(_):
    ...
    parser.add_argument("--layer_num", type=int, default=1, help="LSTM layer num.")
    parser.add_argument("--batch_size", type=int, default=64, help="Batch size.")
    parser.add_argument("--train_step", type=int, default=10000, help="Number of training steps.")
    parser.add_argument("--warmup_step", type=int, default=5000, help="Number of warmup steps.")
    parser.add_argument("--learning_rate", type=float, default=1e-5, help="The initial learning rate")
    ...
    parser.add_argument("--representation_type", type=str, default="transformer", help="representation type include:lstm, transformer")

    #transformer args
    parser.add_argument("--initializer_range", type=float, default="0.02", help="Embedding initialization range")
    parser.add_argument("--max_position_embeddings", type=int, default=140, help="max position num")
    ...
    parser.add_argument("--intermediate_size", type=int, default=1024, help="intermediate_size")
