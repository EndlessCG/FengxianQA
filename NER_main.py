...
def evaluate_and_save_model(args,model,eval_dataset,epoch,global_step,best_f1):
    ...
    logger.info("B-entity precision = %f recall = %f  f1 = %f support = %d", precision_b, recall_b, f1_b,
                support_b)
    logger.info("I-entity precision = %f recall = %f  f1 = %f support = %d", precision_i, recall_i, f1_i,
                support_i)
...
def main():
    ...
    parser.add_argument("--vob_file", default="input/config/bert-base-chinese-vocab.txt", type=str, required=False,
                        help="词表文件")

    parser.add_argument("--model_config", default="input/config/bert-base-chinese-config.json", type=str, required=False,
                        help="模型配置文件json文件")
